...
knitr::include_graphics("Analysis_and_Plotting/num_pub_journal.png")
```
...
knitr::include_graphics("Analysis_and_Plotting/w_p_1.png")
```

```{r wp2, echo=FALSE, fig.cap="Women proportion", out.width = '50%'}
knitr::include_graphics("Analysis_and_Plotting/w_p_2.png")
```
